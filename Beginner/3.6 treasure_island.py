...
if(direction.lower() == 'left'):
  ...
  if(option.lower() == 'wait'):
    color = input(
        '\nYou arrive at an island unharmed.There is a house with 3 doors.One red,one yellow and one blue.Which color do you choose?')
    if(color.lower() == 'red'):
      print("\nYou enter a room of fire. GAME OVER!!!")
    elif(color.lower() == 'blue'):
      print("\nYou enter a room of beasts. GAME OVER!!!")
    elif(color.lower() == 'yellow'):
      print("\nYou got a chest full of treasure. WIN!!!")
  else:
    print("\nThere is a group of crocodiles ahead. GAME OVER!!!")
else:
